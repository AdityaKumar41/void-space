 ...
 */
export const ASSET_LICENSE_REGISTRY_ABI = [
  {
    "type": "constructor",
    "inputs": [
      {
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct AssetLicenseRegistry.LicenseRecord",
        "components": [
          {
            "name": "assetId",
            "type": "string",
